...
class Annotation(models.Model):
    ...
    @classmethod
    def log_session(cls, actor_id=None, actor_full_name=None, actor_avatar=None, client_user_agent=None, application_id=None, meta=None, timestamp=None):
    ...
    @classmethod
    def log_action(cls, parent_timestamp, parent_id, action_url=None, action_method=None, action_version=None, meta=None, timestamp=None, frame_length_ms=None):
        return Annotation.objects.create(
          kind="_st.app.act",
          id=new_id(),
          timestamp=timestamp or timezone.now(),
